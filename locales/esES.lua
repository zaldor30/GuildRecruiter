...
L["PLAYER_NOT_PLAYING"]              = "El jugador no está jugando a World of Warcraft."
...
Informa de cualquier problema en nuestro servidor de Discord.]]
L["AUTO_LOCKED"] = "El movimiento de la ventana está bloqueado."
--#endregion
...
L["BL_NO_ONE_ADDED"]             = "No se añadió a nadie a la lista negra."
L["GUILD_LINK_NOT_FOUND"]        = "No se encontró el enlace de la hermandad. Recarga la IU."
...
L["BLACKLIST_PLAYER"]             = "Añadir jugador a la lista negra"
L["KICK_PLAYER_FROM_GUILD"]       = "Expulsar jugador de la hermandad (añadir a lista negra)"
...
Debido a la integración de Classic y Cata, todos los datos se han restablecido.
...
/gr blacklist <nombre del jugador> - Añade al jugador a la lista negra.]]
L["MINIMAP_TOOLTIP"] = [[
...
L["NO_ANTI_SPAM"]           = "El anti-spam no está habilitado. Actívalo en los ajustes."
...
L["LOCK_TOOLTIP"]           = "Alternar el movimiento de la ventana"
L["RESET_FILTER"]           = "Restablecer filtro"
L["RESET_FILTER_TOOLTIP"]   = "Restablece el filtro del escáner para empezar de nuevo."
L["COMPACT_MODE"]           = "Modo compacto"
L["COMPACT_MODE_TOOLTIP"]   = [[Alternar modo compacto.
Cambia el tamaño del modo compacto en los ajustes.]]
L["ABOUT_TOOLTIP"]          = "Información de Discord, soporte y cómo contribuir."
L["SETTINGS_TOOLTIP"]       = "Cambiar ajustes de Guild Recruiter."
...
L["BLACKLIST_TOOLTIP"]      = "Añadir jugadores a la lista negra."
L["CUSTOM_FILTERS"]         = "Filtros personalizados"
L["CUSTOM_FILTERS_TOOLTIP"] = "Añadir filtros personalizados al escáner."
...
L["MAX_LEVEL_ERROR"]             = "Introduce un número entre 1 y "
...
L["CREATE_MESSAGE_IN_SETTINGS"]  = "Crea el mensaje en los ajustes"
--#endregion
...
L["BLACKLIST_TITLE"]           = "Añadir jugadores seleccionados a la lista negra"
L["BLACKLIST_SCANNER_TOOLTIP"] = "Añade jugadores seleccionados a la lista negra."
L["ANTISPAM_TITLE"]            = "Añadir jugadores seleccionados al anti-spam"
L["ANTISPAM_SCANNER_TOOLTIP"]  = "Añade jugadores seleccionados a la lista anti-spam."
...
L["ADD_TO_ANTISPAM"]           = "Se añadieron %d jugadores a la lista anti-spam."
L["ADD_TO_BLACKLIST"]          = "Se añadieron %d jugadores a la lista negra."
...
--#region About Screen
L["DONATION_MESSAGE"] = [[
Espero que este addon te resulte útil. He invertido mucho tiempo y esfuerzo
...
L["GEN_TOOLTIP_DESC"]            = "Mostrar todas las descripciones emergentes en Guild Recruiter."
...
L["INVITE_SCAN_SETTINGS"]        = "Ajustes de invitación y escaneo"
...
L["KEY_BINDING_NOTE"]            = "Nota: Las asignaciones no afectan a la configuración del teclado de WoW."
--#endregion

--#region GM Invite Settings
L["GM_INVITE_SETTINGS"]               = "Ajustes de GM"
...
NOTA: Tras una sincronización, puede que debas hacer /rl para ver los cambios.]]
L["NEW_MESSAGE_DESC"]           = "Añade una descripción del mensaje a la lista de invitaciones."
...
L["ADDED_TO_BLACK_LIST"]      = "se añadió a la lista negra con el motivo %s."
L["BL_NAME_NOT_ADDED"]        = "no se añadió a la lista negra."
...
Para otro reino, añade - y el nombre del reino.
(NombreDeJugador-NombreDeReino)
]]
--#endregion
...
L["SETTINGS_CHANGED"]      = "Los ajustes se han actualizado."
L["MESSAGE_LIST_CHANGED"]  = "La lista de mensajes se ha actualizado."
L["BLACKLIST_CHANGED"]     = "La lista negra se ha actualizado con %d entradas."
L["ANTISPAM_CHANGED"]      = "La lista anti-spam se ha actualizado con %d entradas."
--#endregion